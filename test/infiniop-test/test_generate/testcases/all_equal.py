...
def equal(a: np.ndarray, b: np.ndarray) -> np.bool:
    """模拟 torch.equal 行为：形状和数据类型必须完全一致，元素值全部相等"""
...
if __name__ == "__main__":
    test_writer = InfiniopTestWriter("all_equal.gguf")
    test_cases = []
