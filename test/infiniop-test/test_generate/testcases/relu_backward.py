...
class ReluBackwardTestCase(InfiniopTestCase):
    ...
    def write_test(self, test_writer: "InfiniopTestWriter"):
        ...
        test_writer.add_tensor(
            test_writer.gguf_key("ans"), grad_input, raw_dtype=gguf.GGMLQuantizationType.F64
        )
...
if __name__ == "__main__":
    ...
    _TEST_CASES_ = [
        ...
        ((5, 8), (0, 1), None, None),
        ((3, 15), (1, 0), None, None),
        ((4, 5, 6), (0, 1, 1), None, None),
        ((4, 5, 6), (1, 0, 1), None, None),
        ((4, 5, 6), (1, 1, 0), None, None),
        ((1, 1), None, None, None),  # 单元素张量
        ((2, 0, 3), None, None, None),  # 零尺寸维度
    ]
